...
class allAddedBody extends StatefulWidget {
  const allAddedBody({Key? key}) : super(key: key);

  @override
  State<allAddedBody> createState() => _allAddedBodyState();
}

class _allAddedBodyState extends State<allAddedBody> {
  ...
  void _editTyreDetails(String carId) async {
        ...
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                TextFormField(
                  controller: _bodyPriceController,
                  decoration: InputDecoration(labelText: 'BodyWork Service Price'),
                ),
                TextFormField(
    ...
    if (shouldEdit == true) {
      ...
      final carRef = FirebaseFirestore.instance.collection('addBodyWorkAdmin').doc(carId);
      await carRef.update({

        'bodyPrice': double.parse(_bodyPriceController.text),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("All BodyWork Services"),
      ),
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('addBodyWorkAdmin').snapshots(),
                            ...
                            children:[
                              IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  _bodyPriceController.text = sedanservicingPrice.toString();
                              ...
                              IconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (shouldDelete == true) {
                                    ...
                                    await FirebaseFirestore.instance.collection('addBodyWorkAdmin').doc(tyreDocument.id).delete();
                                  }
                                },
                              ),
