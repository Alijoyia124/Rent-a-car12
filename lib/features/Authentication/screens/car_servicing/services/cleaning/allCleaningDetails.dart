...
class allCleaningDetails extends StatefulWidget {
  ...
  @override
  State<allCleaningDetails> createState() => _allCleaningDetailsState();
}

class _allCleaningDetailsState extends State<allCleaningDetails> {
  @override
