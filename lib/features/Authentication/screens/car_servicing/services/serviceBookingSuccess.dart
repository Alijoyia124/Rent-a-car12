...
class serviceSuccess  extends StatelessWidget {
  ...
  const serviceSuccess ({Key? key, required this.category, required this.tyreSize}) : super(key: key);
                ...
                Container(
                    child: RichText(
                      text: TextSpan(
                        ...
                        children: <TextSpan>[
                          TextSpan(
                            text: " Congratulations ! you have booked ($category) having Size ($tyreSize) successfully .",
                            style: TextStyle(
                              fontSize: 17,
                              color: Colors.black,
                            ),
                            ...
                            recognizer: TapGestureRecognizer()
                              ..onTap = () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => Mybookings(), // Replace BookingsPage with your actual page class
